...
export const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'projects.weatherapp.desc': 'Başka bir soruyu cevaplayan hava uygulaması: hava nasıl değil, ne zaman çıkmalı. Hangi koşullarda dışarı çıkacağını sen tanımlıyorsun, uygulama hepsini birden karşılayan saat aralıklarını buluyor. Soruyu okuyan model kendi kurduğun makinede yerel olarak koşuyor; dışarı çıkan istek yok.',
  ...
  en: {
    ...
    'projects.weatherapp.desc': 'A weather app that answers a different question: not what the weather is, but when to go out. You set what you will actually go out in, and it finds the stretches that clear all of it. The model that reads your question runs locally, on the machine you host it on.',
